...
### Usage
To use this simple GPT3 app script call the following function in your spreadsheet. The function concatenates the inputs to create a prompt which is sent to GPT3.
```
GPT3(arg1, arg2, ...)
```
